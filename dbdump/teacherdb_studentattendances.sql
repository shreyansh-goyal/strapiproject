...
CREATE TABLE `studentattendances` (
  ...
  `attendanceDayId` int(11) DEFAULT NULL,
...
/*!40000 ALTER TABLE `studentattendances` DISABLE KEYS */;
/*!40000 ALTER TABLE `studentattendances` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-03-01 15:53:49
