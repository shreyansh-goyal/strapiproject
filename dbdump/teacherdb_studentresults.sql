...
CREATE TABLE `studentresults` (
  ...
  `external` double DEFAULT NULL,
  `internal10` double DEFAULT NULL,
  `total` double DEFAULT NULL,
  `hasBack` int(11) DEFAULT NULL,
  `creditScored` int(11) DEFAULT NULL,
  `hasBackCleared` int(11) DEFAULT NULL,
  `clearedInSemester` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  FULLTEXT KEY `SEARCH_STUDENTRESULTS` (`subjectId`)
...
-- Dump completed on 2019-03-01 15:53:52
